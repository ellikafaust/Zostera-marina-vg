...
# rename samples names to not include sequencing run 
bcftools reheader -s ind_rename zostera_300123_ellika_miss25_sorted.vcf  -o zostera_PRJNA1043091_ALL_5849.vcf
...
# ---------- pi.sh ----------
module load vcftools
VCF_FILE="zostera_PRJNA1043091_ALL_5849.vcf"
...
bcftools query -l zostera_PRJNA1043091_ALL_5849.vcf > inds
...
bcftools reheader --sample inds_rename $VCF_FILE -o zostera_PRJNA1043091_ALL_5849.vcf

bcftools view -S no_reps zostera_PRJNA1043091_ALL_5849.vcf -o zoster_341_named.vcf
...
# log for calculation of effective population size
bcftools query -f '%CHROM\t%POS\n' zostera_PRJNA1043091_ALL_5849.vcf | grep "Chr" >pos
